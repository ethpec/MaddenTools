...
file_path = 'Files/Madden24/IE/Season5/SeasonGame.xlsx'
...
def generate_schedule(file_path):
    ...
    (((df['HomeTeam'] == 'Titans') & (df['AwayTeam'] == 'Colts')) |
    ...
    prob += lpSum([x[(game, 0)] for game in games if df.at[game, 'HomeTeam'] == 'Bengals']) == 1
...
with pd.ExcelWriter('Files/Madden24/IE/Season5/CombinedSchedules.xlsx') as writer:

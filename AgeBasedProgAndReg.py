...
# Your File Path
file_path = 'Files/Madden26/IE/Season1/Final_AllStatBased.csv'
regression_values_file_path = 'Files/Madden26/IE/Season1/RegressionValues.xlsx'
...
df.to_csv('Files/Madden26/IE/Season1/Final.csv', index=False)

...
# Your File Path
file_path = 'Files/Madden24/IE/Season5/All.xlsm'
...
df_players.to_csv('Files/Madden24/IE/Season5/PlayerTest.csv', sep=',',index=False)

# Excel Sheets Dataframe (Logic)
df_logic = pd.read_excel('Files/Madden24/IE/Season5/ProgRegLogicCheck.xlsx', sheet_name='Sheet1')
df_logic['StatHigh'] = df_logic['StatValue'].apply(make_high)
df_logic['StatLow'] = df_logic['StatValue'].apply(make_low)
df_logic.to_csv('Files/Madden24/IE/Season5/LogicTest.csv', sep=',',index=False)
...
df_offensiveStats.to_csv('Files/Madden24/IE/Season5/OffTest.csv', sep=',', index=False)
...
df_off_points_agg.to_csv('Files/Madden24/IE/Season5/Points_off.csv', sep=',',index=False)
...
df_def_points_agg.to_csv('Files/Madden24/IE/Season5/Points_def.csv', sep=',',index=False)
...
df_oline_points_agg.to_csv('Files/Madden24/IE/Season5/Points_ol.csv', sep=',',index=False)
...
df_kicking_points_agg.to_csv('Files/Madden24/IE/Season5/Points_kick.csv', sep=',',index=False)
...
df_offensiveStats.to_csv('Files/Madden24/IE/Season5/OffTest.csv', sep=',',index=False)
df_defensiveStats.to_csv('Files/Madden24/IE/Season5/DefTest.csv', sep=',',index=False)
df_olineStats.to_csv('Files/Madden24/IE/Season5/OLTest.csv', sep=',',index=False)
df_kickingStats.to_csv('Files/Madden24/IE/Season5/KickingTest.csv', sep=',',index=False)
# df_defensiveStats_unpivot.to_csv('Files/Madden24/IE/Season5/Defense_Unpivot.csv', sep=',',index=False)

# Export our Final Player DataFrame with updated skills points/regression points
df_final.to_csv('Files/Madden24/IE/Season5/Final_PreAdjustment.csv', sep=',',index=False)
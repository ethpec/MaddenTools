...
# Your File Path
file_path = 'Files/IE/Season18/All.xlsm'
...
df_players = pd.read_excel(file_path, sheet_name='124 Info')
...
df_players.to_csv('Files/IE/Season18/PlayerTest.csv', sep=',',index=False)

# Excel Sheets Dataframe (Logic)
df_logic = pd.read_excel('Files/IE/Season18/ProgRegLogicCheck.xlsx', sheet_name='Sheet1')
df_logic['StatHigh'] = df_logic['StatValue'].apply(make_high)
df_logic['StatLow'] = df_logic['StatValue'].apply(make_low)
df_logic.to_csv('Files/IE/Season18/LogicTest.csv', sep=',',index=False)
...
& (df_offensiveStats['ContractStatus'] == 'Signed') & (df_offensiveStats['GAMESPLAYED'] >= 10) & (df_offensiveStats['DOWNSPLAYED'] >= 300) & (df_offensiveStats['RECEIVECATCHES'] + df_offensiveStats['RUSHATTEMPTS'] >= 15)]
...
df_defensiveStats['DLSacksAndTFLPer1000Snaps'] = ((df_defensiveStats['DLINESACKS'] + df_defensiveStats['DEFTACKLESFORLOSS']) / df_defensiveStats['DOWNSPLAYED']) * 1000
...
df_off_points_agg.to_csv('Files/IE/Season18/Points_off.csv', sep=',',index=False)
...
df_defensiveStats_unpivot = pd.melt(df_defensiveStats,id_vars=['FullName', 'Position', 'TeamName','RatingTier'],value_vars=['DLSacksAndTFLPer1000Snaps','TotalTurnoversPer1000Snaps','LBSacksTFLPassDeflPer1000Snaps','TacklesPer1000Snaps','CBPassDeflPer1000Snaps','CBCatchAllowPer100Snaps','SafetiesCatchAllowMinusPDPerGame'],var_name='StatCheck',value_name='value')
conn = sqlite3.connect(":memory:") # connect to Python memory to be able to query DataFrame variables as if they were tables
df_logic.to_sql("df_logic", conn, index=False)
...
df_def_points_agg.to_csv('Files/IE/Season18/Points_def.csv', sep=',',index=False)
...
df_oline_points_agg.to_csv('Files/IE/Season18/Points_ol.csv', sep=',',index=False)
...
df_kicking_points_agg.to_csv('Files/IE/Season18/Points_kick.csv', sep=',',index=False)
...
df_offensiveStats.to_csv('Files/IE/Season18/OffTest.csv', sep=',',index=False)
df_defensiveStats.to_csv('Files/IE/Season18/DefTest.csv', sep=',',index=False)
df_olineStats.to_csv('Files/IE/Season18/OLTest.csv', sep=',',index=False)
df_kickingStats.to_csv('Files/IE/Season18/KickingTest.csv', sep=',',index=False)
# df_defensiveStats_unpivot.to_csv('Files/IE/Season18/Defense_Unpivot.csv', sep=',',index=False)

# Export our Final Player DataFrame with updated skills points/regression points
df_final.to_csv('Files/IE/Season18/Final.csv', sep=',',index=False)